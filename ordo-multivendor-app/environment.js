...
const useEnvVars = (env = Updates.channel) => {
  ...
  if (env === 'production' || env === 'staging') {
    return {
      GRAPHQL_URL: 'https://ordo-api-production.up.railway.app/graphql',
      WS_GRAPHQL_URL: 'wss://ordo-api-production.up.railway.app/graphql',
      SERVER_URL: 'https://ordo-api-production.up.railway.app/graphql',
      SERVER_REST_URL: 'https://ordo-api-production.up.railway.app/',
