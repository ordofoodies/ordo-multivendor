  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center px-2 py-6 md:px-8 dark:text-white dark:bg-gray-900">
      ...
      <div className="w-full max-w-sm mb-4">
        <CustomButton
          label={t("login")}
          className="bg-primary-color hover:bg-primary-color  text-white dark:text-gray-100 w-full py-3 rounded-full border border-gray-300 dark:border-gray-600 flex justify-center items-center"
