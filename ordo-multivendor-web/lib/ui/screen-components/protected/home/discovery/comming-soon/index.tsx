...
export default function ComingSoonScreen() {
  ...
  return (
    <div onClick={handleClick} className=" cursor-pointer relative flex flex-col rounded-lg items-center justify-center py-8  overflow-hidden  mt-10 text-center bg-gradient-to-b from-primary-color to-[#e6700a] hover:from-[#e6700a] hover:to-primary-color dark:bg-gradient-to-b dark:from-[#cc5500] dark:to-[#994000] dark:hover:from-[#994000] dark:hover:to-[#b84d00] text-white">
